...
<!-- ++++++++hasta aqui se agrego algo nuevo -->

</head>
<body>
	<section id="membrete">
		<div class="logo2">
			<img src="Imagenes/logohome.png" id="logor">
		</div>
		<div class="titulo">
			<h3>LO MEJOR EN GOURMET</h3>
		</div>
	</section>
	<section id="cuerpo">
		<div class="titulo2">
			...
			<div class= "botones">
			 ...
			 <a href="#" > <img src="Imagenes/csv.png" id="csv" title="Generar CSV"></a>
			
			</div>
		</div>
		<?php
			$csv_hdr = "Mesonero, Chef, Fecha, Orden Nº, Pedido";
			$csv_output=""; 
		 ?>
		<div class="filtro">
			 <strong><p>Mesonero:</p><p id="info">Henry</p></strong>
			 <?php $csv_output .="Henry" . ","; ?>			
		</div>
